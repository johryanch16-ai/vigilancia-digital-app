    ...
    <div className="min-h-screen bg-[#0a1128] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <header className="mb-10 text-center sm:text-left flex flex-col sm:flex-row items-center gap-5">
          <div className="relative w-16 h-16 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl flex items-center justify-center border border-blue-500/30 shadow-[0_0_30px_rgba(59,130,246,0.3)]">
            <Shield className="w-10 h-10 text-blue-400 absolute opacity-50" strokeWidth={1} />
            <Cctv className="w-6 h-6 text-cyan-300 relative z-10" strokeWidth={2} />
          </div>
          <div>
